...
<nav id="sidebar"
 ...
 ">
		...
		<div class="sidebar-list" style="background: #0096FF;">
				...
				<a href="index.php?page=laundry" class="nav-item nav-laundry"><span class='icon-field'><i class="fas fa-box"></i></span> Order List</a>
				...
				<a href="index.php?page=inventory" class="nav-item nav-inventory"><span class='icon-field'><i class="fa fa-inventory"></i></span> Inventory</a>
